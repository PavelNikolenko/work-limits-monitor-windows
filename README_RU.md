...
Work Limits Monitor начинается как компактный Windows-монитор лимитов ChatGPT Work и Codex.

Долгосрочная цель проекта: помогать пользователю распределять ограниченный ресурс Work между текущей деятельностью, будущими запланированными задачами и задачами с заданным сроком, опираясь на наблюдаемое потребление ресурса и циклы сброса лимитов.

Сейчас проект сосредоточен на надёжном отображении доступных лимитов. Планирование, прогнозирование и координация задач с учётом ресурса являются направлениями дальнейшего развития, а не текущими функциями.
